...
typedef void(^SCountryThreeListSuccessBlock) (NSString * code, NSString * message, id data, NSString * nums);
typedef void(^SCountryThreeListFailureBlock) (NSError * error);

@interface SCountryThreeList : NSObject
...
@property (nonatomic, strong) SCountryThreeList * data;
