...
typedef void(^SThemeGoodsInfoSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SThemeGoodsInfoFailureBlock) (NSError * error);

@interface SThemeGoodsInfo : NSObject
@property (nonatomic, copy) NSString * goods_id;//商品id

@property (nonatomic, strong) SThemeGoodsInfo * data;
...
@property (nonatomic, strong) SThemeGoodsInfo * goodsInfo;
//@property (nonatomic, copy) NSString * goods_id;//"商品id ",
...
@property (nonatomic, strong) SThemeGoodsInfo * mInfo;
//@property (nonatomic, copy) NSString * merchant_id;//"店铺id",
...
@property (nonatomic, strong) SThemeGoodsInfo * comment;
@property (nonatomic, copy) NSString * total;//"总评论数"
//评论主体
@property (nonatomic, strong) SThemeGoodsInfo * body;
