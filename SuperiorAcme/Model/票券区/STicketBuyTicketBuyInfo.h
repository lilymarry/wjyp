...
typedef void(^STicketBuyTicketBuyInfoSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^STicketBuyTicketBuyInfoFailureBlock) (NSError * error);

@interface STicketBuyTicketBuyInfo : NSObject
@property (nonatomic, copy) NSString * ticket_buy_id;//票券ID商品

@property (nonatomic, strong) STicketBuyTicketBuyInfo * data;
...
@property (nonatomic, strong) STicketBuyTicketBuyInfo * goodsInfo;
...
@property (nonatomic, strong) STicketBuyTicketBuyInfo * mInfo;
//@property (nonatomic, copy) NSString * merchant_id;// "店铺id",
...
@property (nonatomic, strong) STicketBuyTicketBuyInfo * head_user;//": {
