...
typedef void(^SLimitBuyLimitBuyInfoSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SLimitBuyLimitBuyInfoFailureBlock) (NSError * error);

@interface SLimitBuyLimitBuyInfo : NSObject
...
@property (nonatomic, strong) SLimitBuyLimitBuyInfo * data;
...
@property (nonatomic, strong) SLimitBuyLimitBuyInfo * goodsInfo;
...
@property (nonatomic, copy) NSString * sell_num;//"已卖出数量",
...
@property (nonatomic, copy) NSString * end_time;//"本场结束时间",
@property (nonatomic, copy) NSString * start_time;//"本场开始时间",
@property (nonatomic, copy) NSString * limit_price;//"限量购价格",
@property (nonatomic, copy) NSString * limit_store;//"活动库存",
@property (nonatomic, copy) NSString * stage_status;//"活动时间状态"
@property (nonatomic, copy) NSString * is_remind;//是否提醒
...
@property (nonatomic, strong) SLimitBuyLimitBuyInfo * mInfo;
//@property (nonatomic, copy) NSString * merchant_id;//"店铺id",
...
@property (nonatomic, strong) SLimitBuyLimitBuyInfo * comment;
@property (nonatomic, copy) NSString * total;//"总评论数"
//评论主体
@property (nonatomic, strong) SLimitBuyLimitBuyInfo * body;
...
//优惠组合
@property (nonatomic, copy) NSArray * cheap_group;
