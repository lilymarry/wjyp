...
typedef void(^SIntegralBuyOrderSetOrderSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SIntegralBuyOrderSetOrderFailureBlock) (NSError * error);

@interface SIntegralBuyOrderSetOrder : NSObject
@property (nonatomic, copy) NSString * integralBuy_id;//    无界商店id    否    文本    1
...
@property (nonatomic, strong) SIntegralBuyOrderSetOrder * data;
