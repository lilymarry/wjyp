...
typedef void(^SOrderBalancePaySuccessBlock) (NSString * code, NSString * message);
typedef void(^SOrderBalancePayFailureBlock) (NSError * error);

@interface SOrderBalancePay : NSObject
