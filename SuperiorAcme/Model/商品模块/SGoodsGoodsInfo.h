...
typedef void(^SGoodsGoodsInfoSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SGoodsGoodsInfoFailureBlock) (NSError * error);

@interface SGoodsGoodsInfo : NSObject
@property (nonatomic, copy) NSString * goods_id;//商品ID
@property (nonatomic, copy) NSString * p;//分页参数

@property (nonatomic, copy) NSString * buy_status;//0是已下架商品 1是上架商品
@property (nonatomic, strong) SGoodsGoodsInfo * data;
@property (nonatomic, copy) NSString * remarks;//": "本品由得一蜂业旗舰店从境内发货，并提供下单后2小时内发货。"   //注释内容
@property (nonatomic, copy) NSString * is_cart;//"    //是否可以添加购物车  0->不可   1->可以
...
@property (nonatomic, strong) SGoodsGoodsInfo * goodsInfo;
//@property (nonatomic, copy) NSString * goods_id;//"商品id ",
@property (nonatomic, copy) NSString * top_cate_id;//顶级分类id
@property (nonatomic, copy) NSString * cate_id;//": "商品二级分类id",
...
@property (nonatomic, copy) NSArray * goods_active;//商品正在进行的活动
...
@property (nonatomic, copy) NSArray * dj_ticket;//代金券
...
@property (nonatomic, strong) SGoodsGoodsInfo * mInfo;
//@property (nonatomic, copy) NSString * merchant_id;//"店铺id",
...
//@property (nonatomic, copy) NSString * type;//1.满减 2满折
...
@property (nonatomic, strong) SGoodsGoodsInfo * comment;
@property (nonatomic, copy) NSString * total;//"总评论数"
//评论主体
@property (nonatomic, strong) SGoodsGoodsInfo * body;
...
//优惠组合
@property (nonatomic, strong) SGoodsGoodsInfo * cheap_group;
...
@property (nonatomic, copy) NSString *is_active;//is_active == 3  2980商品唯一标示
...
@property (nonatomic, copy) NSString *guarantee_cate;
@property (nonatomic, copy) NSString *present_sale_num;
