...
typedef void(^SMerchantPreListSuccessBlock) (NSString * code, NSString * message, id data, NSString * nums);
typedef void(^SMerchantPreListFailureBlock) (NSError * error);

@interface SMerchantPreList : NSObject
@property (nonatomic, copy) NSString * merchant_id;//店铺id
@property (nonatomic, copy) NSString * p;//分页参数

@property (nonatomic, strong) SMerchantPreList * data;
