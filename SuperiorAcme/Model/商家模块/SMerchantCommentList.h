...
typedef void(^SMerchantCommentListSuccessBlock) (NSString * code, NSString * message, id data, NSString * nums);
typedef void(^SMerchantCommentListFailureBlock) (NSError * error);

@interface SMerchantCommentList : NSObject
