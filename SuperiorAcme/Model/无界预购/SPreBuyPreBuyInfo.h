...
typedef void(^SPreBuyPreBuyInfoSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SPreBuyPreBuyInfoFailureBlock) (NSError * error);

@interface SPreBuyPreBuyInfo : NSObject
@property (nonatomic, copy) NSString * pre_buy_id;//预购id
@property (nonatomic, copy) NSString * p;//

@property (nonatomic, copy) NSString * buy_status;//0是已下架商品 1是上架商品
@property (nonatomic, strong) SPreBuyPreBuyInfo * data;
...
@property (nonatomic, strong) SPreBuyPreBuyInfo * goodsInfo;
...
@property (nonatomic, copy) NSString * sell_num;//":"已预购数量",
...
@property (nonatomic, copy) NSString * start_time;//": "1504800000",//开始时间
@property (nonatomic, copy) NSString * end_time;//": "1504886400",//结束时间戳
@property (nonatomic, copy) NSString * pre_store;//": "80000" //预购多少件发货
...
@property (nonatomic, copy) NSString * pre_price;//": "3.00",//无界预购的价格
//@property (nonatomic, copy) NSString * deposit;//": "1.00",//定金
@property (nonatomic, copy) NSString * end_delivery_date;//": "1512057600",//最晚发货时间
//@property (nonatomic, copy) NSString * start_time;//": "1510416000",//预购开始时间
//@property (nonatomic, copy) NSString * end_time;//": "1511971200",//预购结束时间
@property (nonatomic, copy) NSString * desc;//": "说明活动细节，尾款支付日期，发货时间及周期等等说明。",//活动说明
@property (nonatomic, copy) NSString * is_integral;//": "0",//是否可以使用积分支付 0不可以 1可以
@property (nonatomic, copy) NSString * integral_price;//": "0",//使用积分支付的金额
@property (nonatomic, copy) NSString * success_max_num;//": "0"//预购成功件数，慢XX件发货
@property (nonatomic, copy) NSString * stage_status;//
//商品正在进行的活动
...
@property (nonatomic, strong) SPreBuyPreBuyInfo * mInfo;
//@property (nonatomic, copy) NSString * merchant_id;//": "店铺id",
...
@property (nonatomic, copy) NSString * goods_attr_str;//": "属性组合 属性id用 | 隔开",
@property (nonatomic, copy) NSString * product_sn;//": "货品号",
@property (nonatomic, copy) NSString * product_number;//": "货品库存"

@property (nonatomic, strong) SPreBuyPreBuyInfo * comment;
@property (nonatomic, copy) NSString * total;//"总评论数"
//评论主体
@property (nonatomic, strong) SPreBuyPreBuyInfo * body;
...
//优惠组合
@property (nonatomic, strong) SPreBuyPreBuyInfo * cheap_group;
