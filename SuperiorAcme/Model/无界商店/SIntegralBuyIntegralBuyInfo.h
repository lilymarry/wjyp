...
typedef void(^SIntegralBuyIntegralBuyInfoSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SIntegralBuyIntegralBuyInfoFailureBlock) (NSError * error);

@interface SIntegralBuyIntegralBuyInfo : NSObject
@property (nonatomic, copy) NSString * integral_buy_id;//无界商店商品编号
@property (nonatomic, copy) NSString * p;//

@property (nonatomic, copy) NSString * buy_status;//0是已下架商品 1是上架商品
@property (nonatomic, strong) SIntegralBuyIntegralBuyInfo * data;
...
@property (nonatomic, strong) SIntegralBuyIntegralBuyInfo * goodsInfo;
...
@property (nonatomic, copy) NSString * mall_status;
...
@property (nonatomic, strong) SIntegralBuyIntegralBuyInfo * mInfo;
//@property (nonatomic, copy) NSString * merchant_id;//"店铺id",
...
@property (nonatomic, strong) SIntegralBuyIntegralBuyInfo * comment;
@property (nonatomic, copy) NSString * total;//"1"
//评论主体
@property (nonatomic, strong) SIntegralBuyIntegralBuyInfo * body;
...
//优惠组合
@property (nonatomic, strong) SIntegralBuyIntegralBuyInfo * cheap_group;
...
@property (nonatomic, copy) NSString * pcate_id;
@property (nonatomic, copy) NSString * top_cate_id;
