...
typedef void(^SGroupBuyOrderShoppingCartSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SGroupBuyOrderShoppingCartFailureBlock) (NSError * error);

@interface SGroupBuyOrderShoppingCart : NSObject
@property (nonatomic, copy) NSString * goods_id;//    商品id    否    文本    1
@property (nonatomic, copy) NSString * num;//    数量    否    文本    1
@property (nonatomic, copy) NSString * order_type;//    1直接购买 2拼单    否    文本    1
...
@property (nonatomic, strong) SGroupBuyOrderShoppingCart * data;
