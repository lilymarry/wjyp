...
- (void)viewDidLoad {
    ...
    SDA_Next_top * top = [[SDA_Next_top alloc] initWithFrame:CGRectMake(0, 0, ScreenW, ScreenW/125*71 + 70)];
...
- (void)createNav {
    ...
    [lefthBtn_sub setImage:[UIImage imageNamed:@"导航栏-关闭"] forState:UIControlStateNormal];
...
- (void)lefthBtn_subClick {
    [self.navigationController popToViewController:_s_eb animated:YES];
}
- (void)rigthBtnClick {
