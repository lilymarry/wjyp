...
@property (strong, nonatomic) IBOutlet UIButton *sixBtn;//银两
@property (strong, nonatomic) IBOutlet UILabel *sixNum;

@property (strong, nonatomic) IBOutlet UIButton *sevenBtn;//银两
@property (strong, nonatomic) IBOutlet UILabel *sevenNum;
