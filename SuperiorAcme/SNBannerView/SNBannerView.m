...
//        [cell.bannerImageView sd_setAnimationImagesWithURLs:@[[NSURL URLWithString:[self fetchModelUrl:indexPath.item]]]];
//        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
//            UIImage * image = [UIImage animatedImageWithAnimatedGIFURL:[NSURL URLWithString:[self fetchModelUrl:indexPath.item]]];
//            if (image != nil) {
//                dispatch_async(dispatch_get_main_queue(), ^{
//                    cell.bannerImageView.image = image;
//                });
//            } else {
//                cell.bannerImageView.image = [UIImage imageNamed:@"暂无数据"];
//            }
//        });
//        if (![self.cache objectForKey:[self fetchModelUrl:indexPath.item]]) {
//            dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
//                UIImage * image = [UIImage animatedImageWithAnimatedGIFURL:[NSURL URLWithString:[self fetchModelUrl:indexPath.item]]];
//                [self.cache setObject:image forKey:[self fetchModelUrl:indexPath.item]];
//                if (image != nil) {
//                    dispatch_async(dispatch_get_main_queue(), ^{
//                        cell.bannerImageView.image = image;
//                    });
...
//            });
//        } else {
//            cell.bannerImageView.image = [self.cache objectForKey:[self fetchModelUrl:indexPath.item]];
//        }
...
- (UIPageControl *)pageControl {
    if (!_pageControl) {
        ...
        _pageControl.currentPageIndicatorTintColor = _currentPageTintColor;
