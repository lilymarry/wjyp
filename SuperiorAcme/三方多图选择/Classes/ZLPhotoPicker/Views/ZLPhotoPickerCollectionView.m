...
//        NSString *format = [NSString stringWithFormat:@"现在还能上传%zd张图片",maxCount];
        NSString *format = [NSString stringWithFormat:@"您已经选满图片."];
        if (maxCount <= 0) {
            format = [NSString stringWithFormat:@"您已经选满图片."];
        }
