...
- (UILabel *)pageLabel{
    if (!_pageLabel) {
        ...
        NSString *heightVfl = [NSString stringWithFormat:@"V:|-%.f-[pageLabel(ZLPickerPageCtrlH)]-0-|", STATUS_BAR_HEIGHT];
...
- (UIPageControl *)pageControl{
    if (!_pageControl) {
        ...
        NSString *heightVfl = [NSString stringWithFormat:@"V:[pageControl(ZLPickerPageCtrlH)]-%.f-|", STATUS_BAR_HEIGHT];
