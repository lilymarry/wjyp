...
typedef void(^SgiftShoppingCartModelSuccessBlock) (NSString * code, NSString * message, id data);
typedef void(^SgiftShoppingCartModelFailureBlock) (NSError * error);

@interface SgiftShoppingCartModel : NSObject
...
@property (nonatomic, strong) SgiftShoppingCartModel * data;
...
@property (nonatomic, copy) NSString * use_voucher;//": 5.696,            // 公益金额
@property (nonatomic, copy) NSString * product_id;//":"1"//组和属性id
@property (nonatomic, copy) NSString * server;//": "粉,L",
@property (nonatomic, copy) NSString * after_sale_service;//快递名称
@property (nonatomic, copy) NSString * welfare;//快递名称
@property (nonatomic, copy) NSString * delay_time;//": 5.696,            // 公益金额

//@property (nonatomic, copy) NSString * giftGoods_id;//": 5.696,            // 公益金额
@property (nonatomic, copy) NSString * after_sale_type;//":"1"//组和属性id
@property (nonatomic, copy) NSString * voucher_rate;//": "粉,L",
@property (nonatomic, copy) NSString * is_sale_service;//快递名称
@property (nonatomic, copy) NSString * server_status;//快递名称
@property (nonatomic, copy) NSString * integrity_a;//": 5.696,            // 公益金额

@property (nonatomic, copy) NSString * integrity_b;//": 5.696,            // 公益金额
@property (nonatomic, copy) NSString * integrity_c;//":"1"//组和属性id
@property (nonatomic, copy) NSString * invoice_status;//": "粉,L",
@property (nonatomic, copy) NSString * after_sale_status;//快递名称
@property (nonatomic, copy) NSString * is_welfare;//快递名称
@property (nonatomic, copy) NSString * goods_attr_first;//": 5.696,            // 公益金额




@property (nonatomic, copy) NSString * stock;//": "粉,L",         //商品属性
...
@property (nonatomic, copy) NSString * country_tax;//": 1,   // 是否存在公益金额    （1存在，0不存在）
@property (nonatomic, copy) NSString * return_integral;//": 1,   // 是否存在售后服务类型    （1存在，0不存在）
