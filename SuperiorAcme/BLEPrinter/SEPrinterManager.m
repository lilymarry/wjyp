...
//    NSData *data=[userDefaults objectForKey:@"peripheral"];
//    CBPeripheralModel *mode  =[NSKeyedUnarchiver unarchiveObjectWithData:data];
    return UUIDString;
}
...
//    CBPeripheralModel *modle=[[CBPeripheralModel alloc]init];
//    modle.name=peripheral.name;
//    modle.uuid=peripheral.identifier.UUIDString;
//    NSData *encodemenulist = [NSKeyedArchiver archivedDataWithRootObject:modle];
//    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
//    [defaults setObject:encodemenulist forKey:@"peripheral"];
